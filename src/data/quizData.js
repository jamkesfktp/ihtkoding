export const quizQuestions = [
  {
    ...
    explanation: "JKN adalah singkatan dari Jaminan Kesehatan Nasional, yaitu program jaminan sosial yang diselenggarakan oleh BPJS Kesehatan."
  },
  {
    id: 2,
    ...
    answer: "ICD-10",
    explanation: "ICD-10 (International Classification of Diseases 10th Revision) digunakan untuk mengklasifikasikan kode diagnosis penyakit."
  },
  {
    id: 3,
    ...
    answer: "ICD-9-CM",
    explanation: "ICD-9-CM (International Classification of Diseases, 9th Revision, Clinical Modification) Volume 3 digunakan untuk mengodekan prosedur/tindakan medis."
  },
  {
    id: 4,
    ...
    answer: "INA-CBG / iDRG",
    explanation: "INA-CBG (Indonesia Case Based Groups) dan iDRG adalah sistem pembayaran berbasis paket pengelompokan diagnosis dan tindakan di FKRTL."
  },
  {
    id: 5,
    ...
    explanation: "Dokumen Rekam Medis (khususnya Resume Medis dan Laporan Operasi/Pemeriksaan) adalah dokumen otentik utama yang menjadi dasar pengodean."
  },
  {
    id: 6,
    ...
    explanation: "Ungroupable terjadi jika ada variabel wajib (seperti kode diagnosis, tindakan, berat badan lahir, atau cara pulang) yang tidak konsisten atau belum terisi."
  },
  {
    id: 7,
    ...
    explanation: "Verifikasi klaim JKN dilakukan oleh Verifikator BPJS Kesehatan."
  },
  {
    id: 8,
    ...
    explanation: "Analisis rekam medis (kuantitatif & kualitatif) dilakukan untuk menjamin mutu kelengkapan, keakuratan, dan konsistensi data klinis sebelum dikode."
  },
  {
    id: 9,
    ...
    explanation: "Transformasi Layanan Rujukan berfokus pada peningkatan akses dan kualitas layanan kesehatan tingkat lanjut di rumah sakit."
  },
  {
    id: 10,
    ...
    explanation: "Koder tidak boleh berasumsi atau mengira-ngira. Jika diagnosis tidak jelas, koder wajib berkonsultasi dan mengonfirmasi ke DPJP."
  },
  {
    id: 11,
    ...
    explanation: "Rule MB1 mengatur pemilihan kembali kondisi utama ketika kondisi minor dicatat sebagai kondisi utama sedangkan kondisi yang lebih berat ditangani."
  },
  {
    id: 12,
    ...
    answer: "Volume 3",
    explanation: "ICD-9-CM Volume 3 memuat klasifikasi prosedur medis berbentuk tabular list dan alphabetical index."
  },
  {
    id: 13,
    ...
    explanation: "Analisis Kuantitatif mengecek ketersediaan dan kelengkapan 4 komponen utama dokumen rekam medis (identifikasi, pelaporan, otentikasi, dan tata cara pencatatan)."
  },
  {
    id: 14,
    ...
    answer: "Berat (Mayor)",
    explanation: "Severity Level I = Ringan (tanpa komplikasi), II = Sedang, III = Berat/Mayor (dengan komplikasi berat)."
  },
  {
    id: 15,
    ...
    explanation: "Klaim pending terjadi jika ada ketidakcocokan antara kode klaim dengan bukti pendukung medis."
  },
  {
    id: 16,
    ...
    explanation: "KRIS bertujuan menjamin ekuitas hak dan mutu layanan inap standar yang adil bagi seluruh peserta JKN."
  },
  {
    id: 17,
    ...
    explanation: "Dalam ICD-10, komplikasi spesifik DM dikode menggunakan kombinasi kode DM dengan komplikasi ginjal (misal E11.2) serta kode tambahan untuk tahap CKD."
  },
  {
    id: 18,
    ...
    explanation: "Analisis rekam medis mencegah klaim berstatus pending, dispute, atau klaim tidak terbayar."
  },
  {
    id: 19,
    ...
    explanation: "Penyelesaian ungroupable dilakukan dengan melengkapi variabel data asli sesuai catatan rekam medis."
  },
  {
    id: 20,
    ...
    explanation: "Karakter ke-4 pada subkategori ICD-10 menunjukkan spesifikasi lokasi anatomi, derajat/komplikasi, atau etiologi penyakit."
  }
];
